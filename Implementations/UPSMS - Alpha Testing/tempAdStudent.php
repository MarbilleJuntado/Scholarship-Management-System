                            ...
                            <table class = "table table-hover table-condensed">
                              ...
                              <tbody>
                                <?php 
                                  ...
                                  foreach($student as $temp) {
                                    ...
                                    <tr>
                                      ...
                                      <td class = "pull-right">
                                      	<form method = "post" name = "editStudentForm" action = "tempEditStudent.php">
	                                      	<input type = "hidden" name = "studentID" value = "<?php echo $temp->studentID; ?>">
                                ...
                                ?>
                             	...
                             	<form action = "tempAddStudent.php" class = "text-center">
