								...
								<div class="content">
									<section>
										...
										<header>
                         				...
                         				<form method = "post" name = "scholarshiplist" id = "scholarshiplist" action = "backend/addSig.php">
			                              ...
			                              <table id = "sigTable" class = "table table-striped table-hover table-bordered table-condensed">
			                                ...
			                                <tbody>
			                                  <tr>
			                                    ...
			                                    First Name: <input type = "text" name = "fname[]" value = "<?php echo $sig->firstName; ?>"><br><br>
			                                    
			                                    Middle Name: <input type = "text" name = "mname[]" value = "<?php echo $sig->middleName; ?>"><br><br>
			                                    
			                                    Last Name: <input type = "text" name = "lname[]" value = "<?php echo $sig->lastName; ?>"><br><br>
			                                    
			                                    UP Mail: <input type = "text" name = "mail[]" value = "<?php echo $sig->upMail; ?>"><br><br>

			                                    Position: <input type = "text" name = "position[]" value = "<?php echo $sig->position; ?>"><br><br>                                    
			                                    </td>
			                                  </tr>
			                                </tbody>
			                              </table>
	                            			...
	                            			<div class = "text-center">
	                            				<input type = "submit" name = "sigButton" value = "Edit">
											</div>
										</form>
